...
class triangle_charictar:
    def __init__(self, screen, cords, image_list, range_num):
        ...
        self.counter = 0
    def draw(self):
        global projectiles, paused, pos, pressed
...
class map:
    def __init__(self, data):
        self.rect_list = data[0]
        self.path_list = data[1]
class floating_text:
    red = (255, 0, 0)
    ...
    def __init__(self, screen, cords, image_list, damage, target, path_type, size=(width//50, height//50), colorkey=None, speed=10):
        ...
        if self.path_type == "straight":
            ...
            if self.BC != 0 and self.AC != 0:
                self.angle =int(math.degrees(math.atan(self.BC/self.AC)))
                quad = self.get_quad()
                if quad == 1: pass
...
def main():
    global screen_on, pages, page_on, game_running, menu_ig, charictars_on_screen, money, starting_money, settings_wheel, health, starting_health, enemys, save_vars, map_1, map_2, projectiles, charictars_on_screen, paused, floating_texts, just_opened, map, pressed, pos
    draw_loading_screen()
    init_save_vars()
    just_opened = True
    white = (255, 255, 255)
...
'-', '-', '-', '-', '-', '-', '-', '-', ('base_enemy', 10, ['zombie.png']), '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', ('base_enemy', 10, ['zombie.png'])]
    ...
    while running:
        ...
        if screen_on == "opening":
            ...
            if not paused:
                if counter % 3 == 0:
                    spawn_enemy("base_enemy", 10, map, zombie_image_list)
                    counter = 0
                counter += 1
